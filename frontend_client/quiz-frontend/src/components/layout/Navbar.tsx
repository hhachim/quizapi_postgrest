        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/">
                <span className="text-blue-600 text-xl font-bold">Quiz API</span>
              </Link>
            </div>
        ...
        <div className="pt-2 pb-3 space-y-1">
          ...
          {isAuthenticated && (
            <>
              ...
              <Link href="/quizzes" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800">
                Quizzes
              </Link>
            </>
          )}
